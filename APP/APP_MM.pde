...
// Controle se o quiz foi completado alguma vez
boolean quizCompleto = false;
float melhorPorcentagemQuiz = 0;
...
PImage seloMapa;
PImage seloQuizOuro;
PImage seloQuizPrata;
PImage seloQuizBronze;
...
// Selos especiais: [0]=mapa completo, [1]=quiz (ouro/prata/bronze baseado em %)
boolean seloMapaDesbloqueado  = false;
int     nivelSeloQuiz         = 0; // 0=nenhum, 1=bronze, 2=prata, 3=ouro
